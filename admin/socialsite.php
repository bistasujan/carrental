...
$sql="INSERT INTO socialsite(facebook,twiter,linkedin,google_plus,instagram) VALUES(:facebook,:twitter,:linkedin,:googleplus,:instagram)";

$query = $dbh->prepare($sql);
$query->bindParam(':facebook',$facebook,PDO::PARAM_STR);
$query->bindParam(':twitter',$twiter,PDO::PARAM_STR);
$query->bindParam(':linkedin',$linkedin,PDO::PARAM_STR);
$query->bindParam(':googleplus',$googleplus,PDO::PARAM_STR);
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Social Sites</h2>
