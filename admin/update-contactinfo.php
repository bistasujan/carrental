...
move_uploaded_file($_FILES["logo"]["tmp_name"],"admin/img/logo".$_FILES["logo"]["name"]);


$sql="update tblcontactusinfo set Address=:address,EmailId=:email,ContactNo=:contactno,Logo=:logo";
...
<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="file" class="form-control" value="<?php echo htmlentities($result->Logo);?>" name="logo" id="logo" required>
												</div>
											</div>
<?php }} ?>
