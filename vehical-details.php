      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class='form-group form-goup-sm'>
              <label for='to'>To</label>
              <input type='text' id='to' class='form-control' name='to' placeholder='enter ending destination'>
            </div>

            <div class='form-group form-goup-sm'>
              <label for='from'>from</label>
              <input type='text' id='from' class='form-control' name='from' placeholder='enter  starting destination'>
            </div>

            <div class='form-group form-goup-sm'>
              <label for='cno'>citizenship no</label>
              <input type='text' id='cno' class='form-control' name='cno' placeholder='enter citizenship number'>
            </div>
